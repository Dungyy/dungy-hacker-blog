  ...
  return (
    <div className="top">
      <div className="TopLeft">
        <a href="mailto:erickmunoztech@gmail.com"> <i className="TopLeftIcon TopLeftItem fa-solid fa-square-envelope"></i></a>
        <a href="tel:320-321-4780"><i className="TopLeftIcon fa-solid fa-square-phone"></i></a>
        <a href="https://twitter.com/CodewithDungy"><i className="TopLeftIcon fa-brands fa-twitter-square"></i></a>
        <a href="https://www.linkedin.com/in/dungy/"><i className="TopLeftIcon fa-brands fa-linkedin"></i></a>
      </div>
